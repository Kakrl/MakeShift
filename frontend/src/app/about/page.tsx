      ...
      <div className="flex pl-[clamp(20px,4.2vw,61px)] pr-[clamp(12px,3.2vw,47px)]">
        ...
        <div className="flex-1 aspect-video bg-[#090909] relative overflow-hidden">
          <div className="absolute inset-0 overflow-y-auto p-[48px]">
            ...
            <p className="text-[#d9d9d9] text-[18px] font-sans leading-relaxed mb-[32px] max-w-[560px]">
            ...
            <div className="flex flex-col gap-[24px] max-w-[560px]">
              <div>
                <p className="text-[#c78cff] text-[14px] font-sans uppercase tracking-wider mb-2">Requirements</p>
                <p className="text-[#bdbdbd] text-[16px] font-sans leading-relaxed">
                  A webcam, a flat sheet of paper, and decent lighting. That&apos;s all.
                </p>
              </div>
              <div>
                <p className="text-[#c78cff] text-[14px] font-sans uppercase tracking-wider mb-2">Output</p>
                <p className="text-[#bdbdbd] text-[16px] font-sans leading-relaxed">
                  Export your performance as a standard MIDI file to use in any DAW.
                </p>
              </div>
              <div>
                <p className="text-[#c78cff] text-[14px] font-sans uppercase tracking-wider mb-2">Open Source</p>
                <p className="text-[#bdbdbd] text-[16px] font-sans leading-relaxed">
