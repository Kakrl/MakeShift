...
| 2.2 | Play different octaves with configurable volume | 2.2.1 to 2.2.18 |
...
| 2.2.2 | Unit | Browser pitch across eleven MIDI notes at 44.1/48/96 kHz (interpolated zero-crossing oracle, <0.1 Hz error), velocity amplitude ratio, default 0.7 sustain RMS, attack/release ([source](frontend/browserAudio.test.ts)). User volume control remains unimplemented; native evidence remains separate. | 2.2 | Carl Xu | Vitest offline production DSP | Yes | Partially implemented — pitch/velocity implemented, user volume pending | No (D3) | Implemented 2026-09-22 (partial) | CI pending | Volume setting wiring (#28); no physical sound claim. | [ADSR verification](README.md#browser-envelope-verification-issue-27) — passed 2026-09-24; Actions pending |
...
| 2.2.16 | Integration | Production worklet HTTP asset, soft/loud output ratio, ten-note graph output, stop silence, suspension/restart without replay and navigation cleanup ([source](frontend/browserAudio.browser.mjs)) | 2.2 | Carl Xu | Playwright / Edge + Web Audio analyser | Yes | Implemented — graph only | No | 2026-09-22 | CI pending | Production server and installed browser; hardware audible output excluded. | [ADSR verification](README.md#browser-envelope-verification-issue-27) — passed 2026-09-24 in Edge; Actions pending |
| 2.2.17 | Unit | ADSR sample timing/levels and carrier-boundary bounds at 8/44.1/48/96/192/384 kHz; note-off in attack/decay/sustain and before rendering; duplicate release; same-pitch retrigger, slot reuse and hard stealing in every stage; zero/short durations, zero/full sustain, parameter limits, copied options and block continuity ([source](frontend/browserAudio.test.ts)) | 2.2 | Carl Xu | Vitest offline production DSP | Yes | Implemented — samples only | No (D3) | 2026-09-24 | CI pending | Human listening separate; no physical latency claim. | [Local verification](README.md#browser-envelope-verification-issue-27) — 34 ADSR cases passed; Actions pending |
| 2.2.18 | Integration | Audible ADSR onset, held tone, release, repeated tones/chords and emergency stop ([report](manual/2026-09-24_2.2.18.md)) | 2.2 | Carl Xu | Human listening in production browser | No | User-reported listening PASS; environment not supplied | N/A (manual) | 2026-09-24 | Reported 2026-09-24 | Browser/output device, exact tested commit and individual step details unspecified. | [User report](manual/2026-09-24_2.2.18.md): intended behavior, no sudden stop or audible pops; no instrumented measurement |
